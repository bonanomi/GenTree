void Draw_HiggsPt_0j( std::string var = "higgs_pt", int nbin = 50, float min = 0, float max = 200, std::string nameHR = "Higgs pT") {
  ...
  TH1F* h1 = new TH1F ("h1", "MC generators comparison, 0 jet bins", nbin, min, max);  
  ...
  tree2->Draw(toDraw.Data(), "( ( weights_LHE[9] * (abs(weights_LHE[9]/weights_LHE[0])<100)) + 0 * (abs(weights_LHE[9]/weights_LHE[0])>100)  ) * ((stage1_cat_pTjet30GeV == 102) || (stage1_cat_pTjet30GeV == 103))" );  
  ...
  tree4->Draw(toDraw.Data(), "( ( weights_LHE[9] * (abs(weights_LHE[9]/weights_LHE[0])<100)) + 0 * (abs(weights_LHE[9]/weights_LHE[0])>100)  ) * ((stage1_cat_pTjet30GeV == 102) || (stage1_cat_pTjet30GeV == 103))");
