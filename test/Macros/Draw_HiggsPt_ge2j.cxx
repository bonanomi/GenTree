void Draw_HiggsPt_ge2j( std::string var = "higgs_pt", int nbin = 100, float min = 0, float max = 400, std::string nameHR = "Higgs pT") {
  ...
  tree2->Draw(toDraw.Data(), "( ( weights_LHE[9] * (abs(weights_LHE[9]/weights_LHE[0])<100)) + 0 * (abs(weights_LHE[9]/weights_LHE[0])>100)  ) * ((stage1_cat_pTjet30GeV == 131) || (stage1_cat_pTjet30GeV == 132) || (stage1_cat_pTjet30GeV == 141)) || (stage1_cat_pTjet30GeV == 142))" );  
  
  TTree* tree3 = (TTree*) _file2->Get("GenTree/gentree");  
  TH1F* h3 = new TH1F ("h3", "aMC@nlo", nbin, min, max);  
  toDraw = Form ("%s >> h3", var.c_str());
  tree3->Draw(toDraw.Data(), "( ( weights_LHE[9] * (abs(weights_LHE[9]/weights_LHE[0])<100)) + 0 * (abs(weights_LHE[9]/weights_LHE[0])>100)  ) * ((stage1_cat_pTjet30GeV == 131) || (stage1_cat_pTjet30GeV == 132) || (stage1_cat_pTjet30GeV == 141)) || (stage1_cat_pTjet30GeV == 142))");
  
  TTree* tree4 = (TTree*) _file3->Get("GenTree/gentree");  
  TH1F* h4 = new TH1F ("h4", "minloHJJ", nbin, min, max);  
  toDraw = Form ("%s >> h4", var.c_str());
  tree4->Draw(toDraw.Data(), "( ( weights_LHE[9] * (abs(weights_LHE[9]/weights_LHE[0])<100)) + 0 * (abs(weights_LHE[9]/weights_LHE[0])>100)  ) * ((stage1_cat_pTjet30GeV == 131) || (stage1_cat_pTjet30GeV == 132) || (stage1_cat_pTjet30GeV == 141)) || (stage1_cat_pTjet30GeV == 142))");
